...
class TestCourseViewAcceptance(TestCase):
    ...
    def test_all_course_features_as_admin(self):
        ...
        # EDIT course
        self.client.post("/courses/", {"action": "edit", "courseId": course.id, "newCourseName": "CS 102"})
        course.refresh_from_db()
        self.assertEqual(course.courseName, "CS 102", msg="Course name should be updated")

        # DELETE course
        self.client.post("/courses/", {"action": "delete", "courseId": course.id})
    ...
    def test_course_creation_rejected_for_non_admin(self):
        ...
        response = self.client.post("/courses/", {"action": "create", "courseName": "CS 202"})
    ...
    def test_course_edit_rejected_for_non_admin(self):
        ...
        response = self.client.post(
            "/courses/", {"action": "edit", "courseId": course.id, "newCourseName": "Hacked Name"}
        )
        self.assertEqual(response.status_code, 403)
        course.refresh_from_db()
    ...
    def test_edit_course_with_blanks_does_nothing(self):
        ...
        self.client.post("/courses/", {"action": "create", "courseName": "Original Course"})
        course = Course.objects.get(courseName="Original Course")

        # edit with blank name
        self.client.post("/courses/", {"action": "edit", "courseId": course.id, "newCourseName": ""})
        course.refresh_from_db()
    ...
    def test_course_creation_missing_name(self):
        ...
        response = self.client.post("/courses/", {"action": "create", "courseName": ""})
